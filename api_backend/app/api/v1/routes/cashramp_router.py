...
from app.services.cashramp_service import CashRampService, CustomerResponse, InitiateDepositResponse, RampQuoteResponse
...
async def get_quote(
    ...
    return await cashramp.get_ramp_quote(amount, currency, customer_id, payment_type, payment_method_type)
