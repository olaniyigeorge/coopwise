...
from sqlalchemy import Column, DateTime, Enum as SQLAlchemyEnum, ForeignKey, String, Numeric, JSON
...
class Payment(Base):
    ...
    gateway = Column(SQLAlchemyEnum(PaymentGateway), default=PaymentGateway.OTHER, nullable=False)
    status = Column(SQLAlchemyEnum(PaymentStatus), default=PaymentStatus.INITIATED, nullable=False)
