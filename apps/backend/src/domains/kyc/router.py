...
from src.domains.kyc.dependencies import get_kyc_service
...
@router.post("/identity", status_code=status.HTTP_204_NO_CONTENT)
    ...
    try:
        await service.submit_identity(
            ...
            IdentityInput(
                ...
                selfie_image_content_type=selfie_image.content_type,
...
@router.post("/banking-info", status_code=status.HTTP_204_NO_CONTENT)
