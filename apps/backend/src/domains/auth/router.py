...
from apps.backend.src.domains.auth.schemas import AuthenticatedUser, TokenData
from apps.backend.src.domains.notifications.schemas import NotificationCreate
from apps.backend.src.domains.users.schemas import AuthUser, UserCreate, iAuthWallet
